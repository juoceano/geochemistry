...
\begin{document}
  ...
  \section*{\centerline{\textbf{Relatório 1: Saída de Campo e Descrição da Área de Estudo}}}

  No presente relatório deverão ser descritas, de forma simples e concisa, as atividades realizadas em campo. Além disso, também deverá constar nesse relatório a descrição da área de estudo.

  \section* {1. Formatação}
    \noindent
  \begin{itemize}
    \item[a)] Máximo de 5 páginas (referencias bibliográficas não entram nesse limite);
    \item[b)] Fonte: Times 12 pt;
    \item[c)] Espaçamento 1,5;
    \item[d)] Não há necessidade de capa (se houver capa, esta será contabilizada no limite de 5 páginas).
  \end{itemize}
