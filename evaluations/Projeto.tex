...
\begin{document}
  ...
  \begin{itemize}
    ...
    \item[c)] Não há necessidade de capa (se houver capa, esta será contabilizada no limite de 5 páginas);
    \item[d)] Espaçamento 1.5 ao longo do texto com exceção de onde é explicitamente estipulado diferente no modelo que se encontra no final do documento;
    \item[e)] Fonte: Times New Romam;
    \item[f)] Demais formatações estão descritas no final do documento.
  \end{itemize}
  ...
  \section* {2. Conteúdo }
    \begin{itemize}
      ...
      \item[f)] Objetivos;
      \item[g)] Descrição da área de estudo;
...
*************************************************************************************
  ...
  (Times 11, espaçamento simples entre linhas)
